             ...
             let customerSearchObj = search.create({
                 ...
                 columns:
                     [
                         ...
                         search.createColumn({
                             name: "formulatext",
                             formula: "CASE WHEN {custentity_ptg_lunes_}='T' THEN  'Lunes' WHEN {custentity_ptg_martes_}='T' THEN  'Martes'WHEN {custentity_ptg_miercoles_}='T' THEN  'Miercoles'WHEN {custentity_ptg_jueves_}='T' THEN  'Jueves'WHEN {custentity_ptg_viernes_}='T' THEN  'Viernes'WHEN {custentity_ptg_sabado_}='T' THEN  'Sabado'WHEN {custentity_ptg_domingo_}='T' THEN  'Domingo'ELSE   'No Data' END",
                             label: "Formula (Text)"
                         }),
                         search.createColumn({
                             name: "formulanumeric",
                             formula: "CASE WHEN {custentity_ptg_lunes_}='T' THEN  1 ELSE   7 END",
                             label: "Lunes"
                         }),
                         search.createColumn({
                             name: "formulanumeric",
                             formula: "CASE WHEN {custentity_ptg_martes_}='T' THEN  2 ELSE   7 END",
                             label: "Martes"
                         }),
                         search.createColumn({
                             name: "formulanumeric",
                             formula: "CASE WHEN {custentity_ptg_miercoles_}='T' THEN  3  ELSE   7 END",
                             label: "Miercoles"
                         }),
                         search.createColumn({
                             name: "formulanumeric",
                             formula: "CASE WHEN {custentity_ptg_jueves_}='T' THEN  4 ELSE   7 END",
                             label: "Jueves"
                         }),
                         search.createColumn({
                             name: "formulanumeric",
                             formula: "CASE WHEN {custentity_ptg_viernes_}='T' THEN  5 ELSE   7 END",
                             label: "Viernes"
                         }),
                         search.createColumn({
                             name: "formulanumeric",
                             formula: "CASE WHEN {custentity_ptg_sabado_}='T' THEN  6 ELSE   7 END",
                             label: "Sabado"
                         }),
                         search.createColumn({
                             name: "formulanumeric",
                             formula: "CASE WHEN {custentity_ptg_domingo_}='T' THEN  0 ELSE   7 END",
                             label: "Domingo"
                         }),
                     ...
                     switch (typeService.value) {
                         case '1':
                             ...
                             if (!!itemCilindro) {
                                 ...
                                 opportunityCilindro.setCurrentSublistValue({ sublistId: 'item', fieldId: 'amount', value: 200 });
                         ...
                         case '2':
                             ...
                             if (!!itemEstacionaria) {
                                 ...
                                 opportunityEstacionaria.setCurrentSublistValue({ sublistId: 'item', fieldId: 'amount', value: 200 });
